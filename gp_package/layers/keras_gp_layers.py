...
from ..conditionals import conditional_GP, conditional_orthogonal_GP
...
class Orthogonal_GPLayer(tfp.layers.DistributionLambda):
    """
    A sparse variational multioutput sparse Orthogonal GP layer. This layer holds the kernel,
    inducing variables and variational distribution, and mean function.
    
    #TODO -- introduce documentation about this class
    # inspired by Shi, 2020
    """
    ...
    full_cov: bool
    full_output_cov: bool
    q_mu_u: Parameter # Parameters associated to parametric part of GP, U
    q_sqrt_u: Parameter # Parameters associated to parametric part of GP, U
    q_mu_v: Parameter # Parameters associated to non-parametric part of GP, V
    q_sqrt_v: Parameter # Parameters associated to non-parametric part of GP, V
    ...
    def __init__(
        ...
        *,
        ...
        """
        :param kernel: The multioutput kernel for this layer.
        :param inducing_variable_u: The inducing features for U at this layer.
        :param inducing_variable_v: The inducing features for V at this layer.
        :param num_data: The number of points in the training dataset (see :attr:`num_data`).
        :param mean_function: The mean function that will be applied to the
            inputs. Default: :class:`~gpflow.mean_functions.Identity`.
    ...
    def additional_standard_kl(self) -> tf.Tensor:
        r"""
...
class Heteroskedastic_Orthogonal_GPLayer(tfp.layers.DistributionLambda):
    """
    A sparse variational multioutput sparse Orthogonal GP layer. This layer holds the kernel,
    inducing variables and variational distribution, and mean function.
