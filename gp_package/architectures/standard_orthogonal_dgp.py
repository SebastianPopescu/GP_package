...
from ..models import Orthogonal_DeepGP
...
def build_constant_input_dim_orthogonal_deep_gp(X: np.ndarray, num_layers: int, config: Config) -> Orthogonal_DeepGP:
    r"""
    ...
    return Orthogonal_DeepGP(gp_layers, LikelihoodLayer(likelihood))
