...
from gp_package.layers.keras_gp_layers import Heteroskedastic_Orthogonal_GPLayer

from gp_package.layers.multilatent import HeteroskedasticTFPConditional
...
from ..layers import Orthogonal_GPLayer, LikelihoodLayer
from ..layers import LikelihoodLayer
from ..models import HeteroskedasticDeepGP
...
def build_constant_input_dim_het_orth_deep_gp(X: np.ndarray, num_layers: int, config: Config) -> HeteroskedasticDeepGP:
    r"""
    ...
    for i_layer in range(num_layers):
        ...
        if is_last_layer:
            ...
            layer = Heteroskedastic_Orthogonal_GPLayer(
                kernel,
                inducing_var,
                num_data,
    ...
    return HeteroskedasticDeepGP(gp_layers, LikelihoodLayer(likelihood))
