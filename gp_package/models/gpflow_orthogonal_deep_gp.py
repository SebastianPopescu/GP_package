...
from ..layers import OrthogonalSVGP


class OrthogonalDeepGP(BayesianModel, ExternalDataTrainingLossMixin):
    ...
    def prior_kl_across_layers(self) -> tf.Tensor:
        ...
        for layer in self.f_layers:
            list_KL.append(tf.reduce_sum( layer.prior_kl() ))
        return list_KL
