...
deep_gp: DeepGP = build_constant_input_dim_dist_deep_gp(X, num_layers=2, config=config)

whatever = deep_gp._evaluate_layer_wise_dist_deep_gp(X, None, training=False)
print(whatever)

outputs = deep_gp.call(X, Y, True)
print(outputs)
