...
from gp_package.architectures import Config, build_constant_input_dim_dist_deep_gp, build_constant_input_dim_dist_deep_gp_matern_studentt
...
dist_deep_gp: DistDeepGP = build_constant_input_dim_dist_deep_gp_matern_studentt(X, num_layers=1, config=config, dim_output=1)
