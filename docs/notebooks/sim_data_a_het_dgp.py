...
ax.set_xlabel('Epoch')
ax.set_ylabel('Loss')
plt.savefig(f"./figures/sim_data_a_dataset_loss_het_dgp_num_layers_{NUM_LAYERS}_num_inducing_{NUM_INDUCING}.png")
plt.close()
...
ax.set_xlabel('time')
ax.set_ylabel('acc')
plt.savefig(f"./figures/sim_data_a_dataset_het_dgp_num_layers_{NUM_LAYERS}_num_inducing_{NUM_INDUCING}.png")
plt.close()
